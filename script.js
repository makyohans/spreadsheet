...
const dataGrid = [
    ...
    // BARIS 2
    ['+853 6653 2440', '10067655', 'ꜱ͜͡ᴋᴬ ᭼Candy', '150.000', '150.000', 'Rp 25.000', 'Rp 25.000', 'Rp 16.000', '$ : Rp 0', '0', 'CB SKA : Rp 0', 'Rp 66.000', '085267348782', 'DANA', 'Esti Septiani', 'Anggota'],

    
    // BARIS 3
    ['+62 851 9803 3804', '10015083', 'ꜱ͜͡ᴋᴬ᭼ Nelfi🥀✯⃟»𝙰"', '1.100.000', '1.100.000', 'Rp 200.000', 'Rp 200.000', 'Rp 70.000', '$ : Rp 0', 'BLP R AGC Rp 15.000', 'CB SKA : Rp 50.000', 'Rp 435.000 + SA 2.000 = Rp 437.000', '082298428493', 'DANA', 'Yunelfi', 'Super Admin / Rp 2.000'],

    
    // BARIS 4
    ['+62 831 6828 6042', '10085046', 'ꜱ͜͡ᴋᴬ ᭼𝐒ɦα𝗂𝗋α', '150.000', '150.000', 'Rp 25.000', 'Rp 25.000', 'Rp 16.000', '$ : Rp 0', '0', 'CB SKA : Rp 0', 'Rp 66.000', '083839419665', 'DANA', 'kas125', 'Anggota'],
    ...
    // BARIS 6
    ['+62 812 6933 0165', '10069203', 'ꜱ͜͡ᴋᴬ ᭼W҉A҉H҉Y҉O҉E҉"', '250.000', '250.000', 'Rp 45.000', 'Rp 45.000', 'Rp 20.000', ' $ : Rp 0', '0', 'CB SKA : Rp 40.000', 'Rp 70.000 + SA : Rp 2.000 = Rp 72.000', '081269330165', 'DANA', 'MENANTIUS LAFAU', 'Super Admin / Rp 2.000'],

    
    // BARIS 7
    ['+62 822 5812 7459', '10084725', 'ꜱ͜͡ᴋᴬ ᭼£lsa', '250.000', '250.000', 'Rp 45.000', 'Rp 45.000', 'Rp 20.000', '$ : Rp 0', '0', 'CB SKA : Rp 0', 'Rp 110.000', '081378802067', 'DANA', 'Elsa tri wahyuni', 'Anggota'],

    
    // BARIS 8
    ['+62 813 7869 6785', '10120993', 'ꜱ͜͡ᴋᴬ ᭼Riska', '50.000', '50.000', 'Rp 10.000', 'Rp 10.000', 'Rp 7.000', ' $ : Rp 0', '0', 'CB SKA : Rp 0', 'Rp 27.000', '081378696785', 'DANA', 'Riska Novita Sari', 'Angota'],
    ...
    // BARIS 10
    ['+62 831 8857 3803', '10098483', 'ꜱ͜͡ᴋᴬ ᭼Tika', '250.000', '250.000', 'Rp 45.000', 'Rp 45.000', 'Rp 20.000', '$ : Rp 0', '0', 'CB SKA : Rp 0', 'Rp 110.000', '083178112886', 'GoPay', 'Dewi kartika', 'Anggota'],

    
    // BARIS 11
    ['+62 852 4998 7044', '10112418', 'ꜱ͜͡ᴋᴬ ᭼爱|•sᴀɴᴊɪッ', '100.000', '100.000', 'Rp 20.000', 'Rp 20.000', 'Rp 11.000', ' $ : Rp 0', '0', 'CB SKA : Rp 0', 'Rp 51.000', '085249987044', 'ShopeePay', 'MUHAMMAD RIFAI', 'Angota'],

    
    // BARIS 12
    ['+62 823 5944 5110', '10112534', 'ꜱ͜͡ᴋᴬ ᭼𝐂𝐡𝐨𝐤𝐢', '550.000', '550.000', 'Rp 100.000', 'Rp 100.000', 'Rp 39.000', ' $ : Rp 17.000', 'Rp 6.000', 'CB : Rp = 20.000', 'Rp 242.000', '901715299202', 'Seabank', 'Yek yagil ', 'Angota'],

     
    // BARIS 13
    ['+62 823 5944 5110', '10113857', 'ꜱ͜͡ᴋᴬ ᭼Marvel', '0', '0', 'Rp 0', 'Rp 0', 'Rp 0', '$ : Rp 0', '0', 'CB SKA : Rp 0', 'Rp 0', '901715299202', 'Seabank', 'Yek yagil', 'Anggota'],

    
    // BARIS 14
    ['+62 812 6470 1180', '10027528', 'ꜱ͜͡ᴋᴬ ᭼buaya cuek', '550.000', '550.000', 'Rp 100.000', 'Rp 100.000', 'Rp 39.000', '$ : Rp 0', 'Rp 6.000', 'CB SKA : Rp 0', 'Rp 245.000', '2970638566', 'BCA', 'Liya Fitriani', 'Anggota'],
    ...
    ['+62 821 7207 0365', '10053588', 'ꜱ͜͡ᴋᴬ ᭼NICO"', '100.000', '100.000', 'Rp 20.000', 'Rp 20.000', 'Rp 11.000', ' $ : Rp 0', '0', 'CB SKA : Rp 0', 'Rp 51.000', '-', '-', '-', 'Anggota'],
    
    
    ['+62 821 7207 0365', '10087223', 'ꜱ͜͡ᴋᴬ ᭼Siska', '150.000', '150.000', 'Rp 25.000', 'Rp 25.000', 'Rp 16.000', ' $ : Rp 0', '0', 'CB SKA : Rp 0', 'Rp 66.000', '-', '-', '-', 'Anggota'],

    
    ['+62 821 7207 0365', '10030779', 'ꜱ͜͡ᴋᴬ ᭼Asuwi⚔️', '250.000', '250.000', 'Rp 45.000', 'Rp 45.000', 'Rp 20.000','$ : Rp 17.000', '0', 'CB SKA : Rp 0', 'Rp 127.000', '-', '-', '-', 'Admin Room'],

    
    ['+62 896 4677 5883', '10026365', 'ꜱ͜͡ᴋᴬ ᭼Arow ✯⃟»𝙽"', '550.000', '550.000', 'Rp 100.000', 'Rp 100.000', 'Rp 39.000', '$ : Rp 0', 'Rp 6.000', 'CB SKA : Rp 0', 'Rp 245.000', '089646775883', 'DANA', 'Wi**** H*** M****', 'OWNER SKA'],
