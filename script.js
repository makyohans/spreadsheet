...
const dataGrid = [
    ...
    ['+62 838 3203 2264', '10084043', 'ꜱ͜͡ᴋᴬ ᭼ᴀⷪᴢ‌ⷡᴙⓘɩ', '250.000', '250.000', 'Rp 45.000', 'Rp 45.000', 'Rp 5.200', '$ : Rp 0', '0', 'Rp 95.200', '083832032264', 'DANA', 'Khairul Azri', 'Anggota'],

    
    // BARIS 3 (A3 hingga O3)
    ['+853 6653 2440', '10067655', 'ꜱ͜͡ᴋᴬ ᭼Candy', '250.000', '250.000', 'Rp 45.000', 'Rp 45.000', 'Rp 20.000', '$ : Rp 0', 'GIF 4.000', 'Rp 110.000', '085267348782', 'DANA', 'Esti Septiani', 'Anggota'],

    // BARIS 4 (A4 hingga 04)
    ['+62 821 7207 0365', '10110581', 'ꜱ͜͡ᴋᴬ ᭼Sandi', '150.000', '150.000', 'Rp 25.000', 'Rp 25.000', 'Rp 16.000', ' $ : Rp 0', 'GIF 3.000', 'Rp 66.000', '085267348782', 'DANA', 'Esti Septiani', 'Anggota'],

    
    // BARIS 5 (A5 hingga O5)
    ['+62 851 9803 3804', '10015083', 'ꜱ͜͡ᴋᴬ ᭼Nelfi', '550.000', '550.000', 'Rp 100.000', 'Rp 100.000', 'Rp 39.000', '$ : Rp 0', 'Rp 6.000', 'Rp 239.000 + SA 2.000 = Rp 241.000', '082298428493', 'DANA', 'Yunelfi', 'Super Admin / Rp 2.000'],

    
    // BARIS 6 (A6 hingga O6)
    ['+62 831 6828 6042', '10085046', 'ꜱ͜͡ᴋᴬ ᭼𝐒ɦα𝗂𝗋α', '100.000', '100.000', 'Rp 20.000', 'Rp 20.000', 'Rp 11.000', '$ : Rp 0', 'GIF 2.000', 'Rp 51.000', '083839419665', 'DANA', 'kas125', 'Anggota'],

    
    // BARIS 7 (A7 hingga 07)
    ['+62 878 2624 7644', '10065906', 'ꜱ͜͡ᴋᴬ ᭼🍀DuduLLz🍀', '550.000', '550.000', 'Rp 100.000', 'Rp 100.000', 'Rp 39.000', ' $ : Rp 0', 'Rp 6.000', 'Rp 239.000', '082119792181', 'DANA', 'INEU SETIAWATI', 'Angota'],

    
    // BARIS 8 (A8 hingga 08)
    ['+62 882 9471 5902', '10029550', 'ꜱ͜͡ᴋᴬ ᭼AGUNG', '250.000', '250.000', 'Rp 45.000', 'Rp 45.000', 'Rp 20.000', ' $ : Rp 0', 'GIF 4.000', 'Rp 110.000', '088294715902', 'DANA', 'AGUNG SUWANDI', 'Angota'],

    
    // BARIS 9 (A9 hingga 09)
    ['+62 852 5811 5438', '10065981', 'ꜱ͜͡ᴋᴬ •Naf🥰🫰', '250.000', '250.000', 'Rp 45.000', 'Rp 45.000', 'Rp 20.000', ' $ : Rp 0', 'GIF 4.000', 'Rp 110.000', '085258115438', 'DANA', 'Azizah fitriani ', 'Angota'],

    
    // BARIS 10 (A10 hingga 10)
    ['+62 823 5944 5110', '10112534', 'ꜱ͜͡ᴋᴬ ᭼𝐕𝗲𝗻𝗼𝐌', '250.000', '250.000', 'Rp 45.000', 'Rp 45.000', 'Rp 20.000', ' $ : Rp 0', 'GIF 4.000', 'Rp 110.000', '082359445110', 'DANA', 'Yek yagil ', 'Angota'],

    
    // BARIS 11 (A11 hingga 11)
    ['+62 812 4683 7174', '10076638', 'ꜱ͜͡ᴋᴬ ᭼Salsa hangeul', '150.000', '150.000', 'Rp 25.000', 'Rp 25.000', 'Rp 16.000', ' $ : Rp 0', 'GIF 3.000', 'Rp 66.000 + SA 2.000 = Rp 68.000', '082276671001', 'GoPay', 'Nur istifadah', 'Super Admin / Rp 2.000'],

    
    // BARIS 12 (A12 hingga 12)
    ['+62 831 8857 3803', '10098483', 'ꜱ͜͡ᴋᴬ ᭼Tika', '150.000', '150.000', 'Rp 25.000', 'Rp 25.000', 'Rp 16.000', '$ : Rp 0', 'GIF 3.000', 'Rp 66.000', '083178112886', 'GoPay', 'Dewi kartika', 'Anggota'],

    
    // BARIS 13 (A13 hingga 13)
    ['+62 852 4998 7044', '10112418', 'ꜱ͜͡ᴋᴬ ᭼爱|•sᴀɴᴊɪッ', '150.000', '150.000', 'Rp 25.000', 'Rp 25.000', 'Rp 16.000', ' $ : Rp 0', 'GIF 3.000', 'Rp 66.000', '085249987044', 'ShopeePay', 'MUHAMMAD RIFAI', 'Angota'],

    
    // BARIS 14 (A14 hingga 14)
    ['+62 812 6470 1180', '10027528', 'ꜱ͜͡ᴋᴬ ᭼buaya cuek', '250.000', '250.000', 'Rp 45.000', 'Rp 45.000', 'Rp 20.000', '$ : Rp 0', 'GIF 4.000', 'Rp 110.000', '2970638566', 'BCA', 'Liya Fitriani', 'Anggota'],

    
    // BARIS 15 (A15 hingga 15)
    ['+62 822 5812 7459', '10084725', 'ꜱ͜͡ᴋᴬ ᭼£lsa', '100.000', '100.000', 'Rp 20.000', 'Rp 20.000', 'Rp 11.000', '$ : Rp 0', 'GIF 2.000', 'COIN : 61.750', '204301012055508', 'BRI', 'Elsa tri wahyuni', 'Anggota'],


    // BARIS 15 (A15 hingga 15)
    ['+62 838 5722 1637', '10035015', 'ꜱ͜͡ᴋᴬ ᭼Dont`care', '250.000', '250.000', 'Rp 45.000', 'Rp 45.000', 'Rp 5.200', '$ : Rp 0', '0', 'Rp 95.200', '083857221637', 'DANA', 'M PARHAN NUDIN', 'Anggota'],




    
    ['+62 821 7207 0365', '10087223', 'ꜱ͜͡ᴋᴬ ᭼Siska', '100.000', '100.000', 'Rp 20.000', 'Rp 20.000', 'Rp 11.000', ' $ : Rp 0', 'GIF 2.000', 'Rp 51.000', '-', '-', '-', 'Anggota'],
